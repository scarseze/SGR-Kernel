---- MODULE LeaseProtocol_TTrace_1772735032 ----
...
\* to `JsonSerialize`. For example, a sub-sequence of _TETrace.
    \* ASSUME
    \*     LET J == INSTANCE Json
    \*         IN J!JsonSerialize("LeaseProtocol_TTrace_1772735032.json", _TETrace)
...
\*
\*trace == IODeserialize("LeaseProtocol_TTrace_1772735032.bin", TRUE)
\*
\*=============================================================================
\*
...
trace == 
    ...
    ([db_lease_ver |-> 1,worker_state |-> (w1 :> "CRASHED" @@ w2 :> "IDLE" @@ w3 :> "IDLE"),worker_lease |-> (w1 :> 1 @@ w2 :> 0 @@ w3 :> 0),db_state |-> "RUNNING"]),
    ([db_lease_ver |-> 1,worker_state |-> (w1 :> "IDLE" @@ w2 :> "IDLE" @@ w3 :> "IDLE"),worker_lease |-> (w1 :> 1 @@ w2 :> 0 @@ w3 :> 0),db_state |-> "RUNNING"])
    >>
----
...
---- CONFIG LeaseProtocol_TTrace_1772735032 ----
CONSTANTS
    Workers = { w1 , w2 , w3 }
    MaxLease = 5
    w3 = w3
...
ALIAS
    _expression
=============================================================================
\* Generated on Thu Mar 05 21:23:53 MSK 2026