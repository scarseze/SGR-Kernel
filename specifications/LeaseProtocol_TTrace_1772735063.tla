---- MODULE LeaseProtocol_TTrace_1772735063 ----
...
\* to `JsonSerialize`. For example, a sub-sequence of _TETrace.
    \* ASSUME
    \*     LET J == INSTANCE Json
    \*         IN J!JsonSerialize("LeaseProtocol_TTrace_1772735063.json", _TETrace)
...
\*
\*trace == IODeserialize("LeaseProtocol_TTrace_1772735063.bin", TRUE)
\*
\*=============================================================================
\*
...
---- CONFIG LeaseProtocol_TTrace_1772735063 ----
CONSTANTS
    Workers = { w1 , w2 , w3 }
    MaxLease = 5
    w1 = w1
...
ALIAS
    _expression
=============================================================================
\* Generated on Thu Mar 05 21:24:24 MSK 2026