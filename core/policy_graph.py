...
class RetryGraph:
    ...
    def decide_next_action(self, failure_reason: FailureReason, current_retry_count: int) -> RecoveryAction:
        """
...
PolicyRegistry.register(
    "strict", RetryPolicy(max_retries=1, action_map={FailureReason.SCHEMA_VALIDATION_FAILED: RecoveryAction.FAIL_FAST})
)
