...
class GostData(BaseModel):
    ...
    foundation_documents: str = Field(
        default="Договор № 01/2026 от 01.01.2026", description="Documents serving as basis"
    )
...
class GostWriterInput(BaseModel):
    ...
    template_type: Literal["tz", "manual", "pmi"] = Field(default="tz", description="Type of document to generate.")
