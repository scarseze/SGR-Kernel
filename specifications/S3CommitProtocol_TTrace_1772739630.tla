---- MODULE S3CommitProtocol_TTrace_1772739630 ----
...
_inv ==
    ~(
        ...
        /\
        s3_files = ({<<j1, 1, "data.bin">>})
        /\
        consumer_reads = ((j1 :> "INVALID_PARTIAL_READ" @@ j2 :> "NONE"))
    )
----
...
\* to `JsonSerialize`. For example, a sub-sequence of _TETrace.
    \* ASSUME
    \*     LET J == INSTANCE Json
    \*         IN J!JsonSerialize("S3CommitProtocol_TTrace_1772739630.json", _TETrace)
...
\*
\*trace == IODeserialize("S3CommitProtocol_TTrace_1772739630.bin", TRUE)
\*
\*=============================================================================
\*
...
trace == 
    ...
    ([s3_files |-> {<<j1, 1, "data.bin">>},consumer_reads |-> (j1 :> "INVALID_PARTIAL_READ" @@ j2 :> "NONE")])
    >>
----
...
---- CONFIG S3CommitProtocol_TTrace_1772739630 ----
CONSTANTS
    Jobs = { j1 , j2 }
    MaxAttempts = 2
    j1 = j1
...
ALIAS
    _expression
=============================================================================
\* Generated on Thu Mar 05 22:40:31 MSK 2026