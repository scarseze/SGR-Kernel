...
class GostWriterSkill(BaseSkill[BaseModel]):
    ...
    def __init__(self, llm_service: LLMService | None = None, **data):
        super().__init__(**data)
    ...
    async def execute(self, params: GostWriterInput, state: ExecutionState) -> str:
