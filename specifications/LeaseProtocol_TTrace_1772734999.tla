---- MODULE LeaseProtocol_TTrace_1772734999 ----
...
\* to `JsonSerialize`. For example, a sub-sequence of _TETrace.
    \* ASSUME
    \*     LET J == INSTANCE Json
    \*         IN J!JsonSerialize("LeaseProtocol_TTrace_1772734999.json", _TETrace)
...
\*
\*trace == IODeserialize("LeaseProtocol_TTrace_1772734999.bin", TRUE)
\*
\*=============================================================================
\*
...
---- CONFIG LeaseProtocol_TTrace_1772734999 ----
CONSTANTS
    Workers = { w1 , w2 , w3 }
    MaxLease = 5
    w3 = w3
...
ALIAS
    _expression
=============================================================================
\* Generated on Thu Mar 05 21:23:20 MSK 2026