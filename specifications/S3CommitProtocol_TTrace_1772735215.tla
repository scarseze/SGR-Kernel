---- MODULE S3CommitProtocol_TTrace_1772735215 ----
...
_prop ==
    ~(([]<>(
            ...
            s3_files = ({<<j1, 1, "data.bin">>, <<j1, 1, "_SUCCESS">>, <<j1, 2, "data.bin">>, <<j2, 1, "data.bin">>, <<j2, 1, "_SUCCESS">>, <<j2, 2, "data.bin">>})
            /\
            consumer_reads = ((j1 :> "NONE" @@ j2 :> "VALID_DATA_READ"))
    )))
----
...
\* to `JsonSerialize`. For example, a sub-sequence of _TETrace.
    \* ASSUME
    \*     LET J == INSTANCE Json
    \*         IN J!JsonSerialize("S3CommitProtocol_TTrace_1772735215.json", _TETrace)
...
\*
\*trace == IODeserialize("S3CommitProtocol_TTrace_1772735215.bin", TRUE)
\*
\*=============================================================================
\*
...
trace == 
    ...
    ([s3_files |-> {<<j1, 2, "data.bin">>},consumer_reads |-> (j1 :> "NONE" @@ j2 :> "NONE")]),
    ([s3_files |-> {<<j1, 1, "data.bin">>, <<j1, 2, "data.bin">>},consumer_reads |-> (j1 :> "NONE" @@ j2 :> "NONE")]),
    ([s3_files |-> {<<j1, 1, "data.bin">>, <<j1, 2, "data.bin">>, <<j2, 1, "data.bin">>},consumer_reads |-> (j1 :> "NONE" @@ j2 :> "NONE")]),
    ([s3_files |-> {<<j1, 1, "data.bin">>, <<j1, 2, "data.bin">>, <<j2, 1, "data.bin">>, <<j2, 2, "data.bin">>},consumer_reads |-> (j1 :> "NONE" @@ j2 :> "NONE")]),
    ([s3_files |-> {<<j1, 1, "data.bin">>, <<j1, 1, "_SUCCESS">>, <<j1, 2, "data.bin">>, <<j2, 1, "data.bin">>, <<j2, 2, "data.bin">>},consumer_reads |-> (j1 :> "NONE" @@ j2 :> "NONE")]),
    ([s3_files |-> {<<j1, 1, "data.bin">>, <<j1, 1, "_SUCCESS">>, <<j1, 2, "data.bin">>, <<j2, 1, "data.bin">>, <<j2, 1, "_SUCCESS">>, <<j2, 2, "data.bin">>},consumer_reads |-> (j1 :> "NONE" @@ j2 :> "NONE")]),
    ([s3_files |-> {<<j1, 1, "data.bin">>, <<j1, 1, "_SUCCESS">>, <<j1, 2, "data.bin">>, <<j2, 1, "data.bin">>, <<j2, 1, "_SUCCESS">>, <<j2, 2, "data.bin">>},consumer_reads |-> (j1 :> "NONE" @@ j2 :> "VALID_DATA_READ")]),
...
---- CONFIG S3CommitProtocol_TTrace_1772735215 ----
CONSTANTS
    Jobs = { j1 , j2 }
    MaxAttempts = 2
    j2 = j2
...
ALIAS
    _expression
=============================================================================
\* Generated on Thu Mar 05 21:26:57 MSK 2026