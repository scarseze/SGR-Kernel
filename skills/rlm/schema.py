...
class RLMInput(BaseModel):
    ...
    context_text: Optional[str] = Field(
        default=None,
        description="Use this ONLY for short raw text typed by the user. NEVER populate this from message history or if a file is mentioned.",
    )
    context_file_path: Optional[str] = Field(
        default=None,
        description="Absolute path to the file to analyze. REQUIRED if user mentions a file. This is the preferred method for long content.",
    )
