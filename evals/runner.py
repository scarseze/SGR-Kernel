...
class BatchEvaluator:
    def __init__(self, engine: Any, agent: Any, graders: List[Any]):
        self.engine = engine
        self.agent = agent
...
def aggregate_results(records: List[EvaluationRecord]):
    ...
    global_results: Dict[str, Any] = {"total": len(records), "passed": 0, "avg_latency": 0.0, "scores": {}}
    ...
    for _slc, data in slice_results.items():
