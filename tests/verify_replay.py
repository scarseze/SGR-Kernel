...
class TestReplayMode(unittest.IsolatedAsyncioTestCase):
    async def test_record_and_replay(self):
        ...
        # Make a call
        resp, meta = await engine.model_pool.heavy.generate_structured("Sort list", "A, B", EchoModel)
        ...
        # Make SAME call
        resp2, meta2 = await engine2.model_pool.heavy.generate_structured("Sort list", "A, B", EchoModel)
