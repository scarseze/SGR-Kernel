...
class CheckpointManager:
    ...
    def __init__(self, storage_path: str = None):
        self.storage_path = storage_path or os.getenv("CHECKPOINT_PATH", "checkpoints")
    ...
    def save_checkpoint(self, state: ExecutionState, reason: str) -> str:
        """
        ...
        ckpt = Checkpoint(
            ...
            if hasattr(state, "current_step_id")
            else None,  # ExecutionState removed current_step_id logic largely?
    ...
    def get_latest_checkpoint(self, request_id: str) -> Optional[str]:
        ...
        files = [os.path.join(request_dir, f) for f in os.listdir(request_dir) if f.endswith(".json")]
