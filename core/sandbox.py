...
class SkillSandbox:
    ...
    def __init__(
        self, dry_run: bool = False, timeout_seconds: float = 300.0, allowed_capabilities: Optional[set] = None
    ):
    ...
    async def execute(
        self, skill_name: str, params: Dict[str, Any], func: Callable[..., Awaitable[Any]], state: Any = None
    ) -> Any:
