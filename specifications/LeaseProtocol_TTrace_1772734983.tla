---- MODULE LeaseProtocol_TTrace_1772734983 ----
...
_inv ==
    ~(
        ...
        db_lease_ver = (3)
        /\
        worker_state = ((w1 :> "CRASHED" @@ w2 :> "CRASHED" @@ w3 :> "CRASHED"))
        /\
        worker_lease = ((w1 :> 1 @@ w2 :> 2 @@ w3 :> 3))
        /\
        db_state = ("QUEUED")
    )
----
...
\* to `JsonSerialize`. For example, a sub-sequence of _TETrace.
    \* ASSUME
    \*     LET J == INSTANCE Json
    \*         IN J!JsonSerialize("LeaseProtocol_TTrace_1772734983.json", _TETrace)
...
\*
\*trace == IODeserialize("LeaseProtocol_TTrace_1772734983.bin", TRUE)
\*
\*=============================================================================
\*
...
trace == 
    ...
    ([db_lease_ver |-> 3,worker_state |-> (w1 :> "CRASHED" @@ w2 :> "WORKING" @@ w3 :> "WORKING"),worker_lease |-> (w1 :> 1 @@ w2 :> 2 @@ w3 :> 3),db_state |-> "QUEUED"]),
    ([db_lease_ver |-> 3,worker_state |-> (w1 :> "CRASHED" @@ w2 :> "CRASHED" @@ w3 :> "WORKING"),worker_lease |-> (w1 :> 1 @@ w2 :> 2 @@ w3 :> 3),db_state |-> "QUEUED"]),
    ([db_lease_ver |-> 3,worker_state |-> (w1 :> "CRASHED" @@ w2 :> "CRASHED" @@ w3 :> "CRASHED"),worker_lease |-> (w1 :> 1 @@ w2 :> 2 @@ w3 :> 3),db_state |-> "QUEUED"])
    >>
----
...
---- CONFIG LeaseProtocol_TTrace_1772734983 ----
CONSTANTS
    Workers = { w1 , w2 , w3 }
    MaxLease = 5
    w2 = w2
...
ALIAS
    _expression
=============================================================================
\* Generated on Thu Mar 05 21:23:03 MSK 2026