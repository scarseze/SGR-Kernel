...
async def build_engine():
    ...
    if proxy_url:
        ...
        llm_config = {"base_url": proxy_url + "/v1", "api_key": "dummy-key", "model": "deepseek-chat"}
    elif deepseek_key:
        logger.info("Using Direct DeepSeek API (INSECURE)")
        llm_config = {"base_url": "https://api.deepseek.com", "api_key": deepseek_key, "model": "deepseek-chat"}
